        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-lg bg-background hover:bg-primary hover:text-white transition-all duration-300 ease-out flex items-center justify-center"
              >
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M8.29 20v-7.21H5.5V9.25h2.79V7.25c0-2.77 1.69-4.29 4.17-4.29 1.19 0 2.2.09 2.5.13v2.9h-1.72c-1.34 0-1.6.64-1.6 1.57v2.05h3.2l-.42 3.54h-2.78V20" />
                </svg>
              </a>
              <a
                href="#"
